...
const SubscriptionCard = ({ name, price, currency, icon, billing, color, category, plan, startDate, renewalDate, paymentMethod, status, expanded, onPress }: SubscriptionCardProps) => {
